...
import top.ldtianzhe.mylibrary.adapter.LendReturnRecordsAdapter;
import top.ldtianzhe.mylibrary.api.GetApi;
import top.ldtianzhe.mylibrary.model.LendReturnRecord;
import top.ldtianzhe.mylibrary.model.response.LendReturnRecordResponse;
...
public class LendReturnRecordsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle("LIBRARY-借阅记录");
        }
