package top.ldtianzhe.web.book.config;
...
//        pars.add(tokenPar.build());    //根据每个方法名也知道当前方法在设置什么参数
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //为当前包路径
                .apis(RequestHandlerSelectors.basePackage("io.ldtianzhe.web.book.controller"))
...
//                .globalOperationParameters(pars);
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                //创建人
                .contact(new Contact("凌渡 。-", "https://ldtianzhe.top", "ldtianzhe.top"))
                //版本号
                .version("1.0")
                //描述
                .description("API 描述")
